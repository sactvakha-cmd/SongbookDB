...
const i18n = {
  ...
  an: { app_title: "Aqkaq kalizaq DawrCar deuq.", search_placeholder: "Bof-awr pov-awq...", manage_text: "Haw-awr lavsav-eu", total_songs: "Dawqcar dawqtawvluf", group_songs: "Dawqcawr armaf", song_count_label: "Dawqcar:", song_unit: "bymr", nav_home: "Danqbae", nav_profile: "Yawqha-euq", nav_categories: "Armaf", cat_life: "Aqkaq kalizaq Car-eu Sanqbof", cat_gen: "Aqkaq kalizaq cardawq nuideuq.", cat_xmas: "Kirsarmax DawqCar", cat_sad: "Shirbui-anr car-eu Dawqcar", cat_wed: "Oermr barngae Car-eu Dawqcar", cat_praise: "Jaceuq-euu dawqcar", cat_worship: "Uqduq tanq-eu DawqCar", cat_other: "Dawqcar Nuideuq.", nav_cat_life: "Sanqbof", nav_cat_gen: "Nuideuq.", nav_cat_xmas: "Kirsarmax", nav_cat_sad: "Shirbui", nav_cat_wed: "Oermr", nav_cat_praise: "Jaceuq", nav_cat_worship: "Uqduq", nav_cat_other: "Nuideuq.", nav_music: "Dawqcar tersar", music_mp3: "MP3 Narhaq-eu", music_play_all: "Dawqcar dawqtawv luf", menu_copy: "Dawqcar sanqbof Copy", menu_share: "Dawqcar Share", menu_print: "Print / Save PDF", label_chord: "Chords:", lyric_new: "Aqkaq New", lyric_old: "Aqkaq Old", music_tab_list: "Dawqcar tersr", music_tab_play: "Narhaq luf", music_tab_lyric: "Darcar Carbof" },
  ao: { app_title: "Aˬkaˬ kalizaˬ Caˇdawˬ", search_placeholder: "Boꞈ-awˇ poˆ-awˬ...", manage_text: "Haw-awˇ Laˆsaˆ-eu", total_songs: "Dawˬcaˇ Dawˬtawˆluꞈ", group_songs: "Dawˬcaˇ aˇmaꞈ", song_count_label: "Dawˬcaˇ:", song_unit: "bymˇ", nav_home: "Dahˬbeh", nav_profile: "Yawˬha-euˬ", nav_categories: "Aˇmaꞈ", cat_life: "Aˬkaˬ kalizaˬ Caˇ-eu Sahˬboꞈ", cat_gen: "Aˬkaˬ kalizaˬ Caˇdawˬ Nuideuˬ", cat_xmas: "Kiˇsaˇmaˇ Dawˬcaˇ", cat_sad: "Shiˇbui", cat_wed: "Oeˇmˇ baˇgaˇ Caˇ-eu dawˬcaˇ", cat_praise: "Jaceuˬ-eu Dawˬcaˇ", cat_worship: "Uˬduˬ tahˬ-eu Dawˬcaˇ", cat_other: "Dawˬcaˇ Nuideuˬ", nav_cat_life: "Sahˬboꞈ", nav_cat_gen: "Nuideuˬ", nav_cat_xmas: "Kiˇsaˇmaˇ", nav_cat_sad: "Shiˇbui", nav_cat_wed: "Oeˇmˇ", nav_cat_praise: "Jaceuˬ", nav_cat_worship: "Uˬduˬ", nav_cat_other: "Nuideuˬ", nav_music: "Dawˬcaˬ teˇsaˇ", music_mp3: "MP3 Naˇhaˬ-eu", music_play_all: "Dawˬcaˇ dawˬtawˆluꞈ", menu_copy: "Dawˬcaˇ sahˬboꞈ Copy", menu_share: "Dawˬcaˇ Share", menu_print: "Print / Save PDF", label_chord: "Chords:", lyric_new: "Aˬkaˬ New", lyric_old: "Aˬkaˬ Old", music_tab_list: "Dawˬcaˬ teˇsaˇ", music_tab_play: "Naˇhaˬ luꞈ", music_tab_lyric: "Dawˬcaˇ Caˇboꞈ" }
};
